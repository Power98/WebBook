    ...
    render() {
        ...
        return (
            <header>
                ...
                <nav>
                    <ul>
                        <li><Link to="/product">สินค้าใหม่</Link></li>
                        <li><Link to="/ProductsRecommend">สินค้าขายดี</Link></li>
                        <li><Link to="/สินค้าลดราคา">สินค้าลดราคา</Link></li>
                        <li><Link to="/สินค้าแนะนำ">สินค้าแนะนำ</Link></li>
                    ...
                    <div className="searah">
                        <FontAwesomeIcon icon={faSearch} onClick={Cc}/>
                    </div>
                        <nav>
